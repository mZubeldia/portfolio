              ...
              <nav className="card_nav">
                <ul className="card_nav_list">
                  <li className="list_element">
                    <a
                      className="list_element_link"
                      href="https://github.com/mZubeldia/rick-and-morty-character-search"
                    >
                  ...
                  <li className="list_element">
                    <a
                      className="list_element_link"
                      href="https://mzubeldia.github.io/rick-and-morty-character-search/#/"
                    >
              ...
              <nav className="card_nav">
                <ul className="card_nav_list">
                  <li className="list_element">
                    <a
                      className="list_element_link"
                      href="https://github.com/mZubeldia/gifExpertApp"
                    >
                      <i className="fas fa-code"></i>
                    </a>
                  </li>
                  <li className="list_element">
                    <a
                      className="list_element_link"
                      href="https://mzubeldia.github.io/gifExpertApp/"
                    >
                      <i className="fas fa-laptop"></i>
                    </a>
                  </li>
              ...
              <nav className="card_nav">
                <ul className="card_nav_list">
                  <li className="list_element">
                    <a
                      className="list_element_link"
                      href="https://github.com/mZubeldia/series-search-engine"
                    >
                      <i className="fas fa-code"></i>
                    </a>
                  </li>
                  <li className="list_element">
                    <a
                      className="list_element_link"
                      href="https://mzubeldia.github.io/series-search-engine/"
                    >
                      <i className="fas fa-laptop"></i>
                    </a>
                  </li>
              ...
              <nav className="card_nav">
                <ul className="card_nav_list">
                  <li className="list_element">
                    <a
                      className="list_element_link"
                      href="https://github.com/mZubeldia/easy-delivery"
                    >
                      <i className="fas fa-code"></i>
                    </a>
                  </li>
                  <li className="list_element">
                    <a
                      className="list_element_link"
                      href="https://mzubeldia.github.io/easy-delivery/#/"
                    >
                      <i className="fas fa-laptop"></i>
                    </a>
                  </li>
